<?php namespace R4L\LocalizePlugin\Behaviors;

use R4L\LocalizePlugin\Classes\LocalizationModel;
...
class IndexLocalizationOperations extends \RainLab\Builder\Behaviors\IndexLocalizationOperations
{
    public function __construct($controller)
    {
        ...
        $this->viewPath = '$/rainlab/builder/behaviors/indexlocalizationoperations/partials';
    }
